...
creation line still said mixed-case `Ida Vessel. I audited leases for
eleven years before I read one of my own.`

**What changed.** `IDA VESSEL. I AUDITED LEASES FOR ELEVEN YEARS BEFORE
I READ ONE OF MY OWN.`
...
## Stage 623 — m7 TAKE THE CHAIR (Estate) said with Ida at your shoulder

**Goal.** Stage 622 taught the Clockeater chair. m7's Estate TAKE THE
CHAIR choice still said mixed-case `TAKE THE CHAIR — with Ida at your
shoulder.`

**What changed.** `TAKE THE CHAIR — WITH IDA AT YOUR SHOULDER.`
...
## Stage 622 — m7 TAKE THE CHAIR (Clockeater) said and set the model to forget

**Goal.** Stage 621 taught WIPE THE LEDGER. m7's Clockeater TAKE THE
CHAIR choice still said mixed-case `TAKE THE CHAIR — and set the model
to forget.`

**What changed.** `TAKE THE CHAIR — AND SET THE MODEL TO FORGET.`
...
## Stage 621 — m7 WIPE THE LEDGER said walk out free

**Goal.** Stage 620 taught REDACTED. m7's WIPE THE LEDGER choice still
said mixed-case `WIPE THE LEDGER. Walk out free.`

**What changed.** `WIPE THE LEDGER. WALK OUT FREE.`
...
still said mixed-case `FULL BROADCAST. Let them read the fire too.`

**What changed.** `FULL BROADCAST. LET THEM READ THE FIRE TOO.`
...
still said mixed-case `KEEP THE DIRECTIVE. If it's a weapon, it's mine
now.`

**What changed.** `KEEP THE DIRECTIVE. IF IT'S A WEAPON, IT'S MINE NOW.`
...
said mixed-case `PUBLISH IT on every leased feed tonight.`

**What changed.** `PUBLISH IT ON EVERY LEASED FEED TONIGHT.`
...
## Stage 610 — m2 TURN HIM IN said to Marrow's people

**Goal.** Stage 609 taught SPARE HIM. m2's TURN HIM IN choice still
said mixed-case `TURN HIM IN to Marrow's people. The Clockeaters
settle their own.`

**What changed.** `TURN HIM IN TO MARROW'S PEOPLE. THE CLOCKEATERS
SETTLE THEIR OWN.`
...
mixed-case `KEEP IT. Evidence is a weapon.`

**What changed.** `KEEP IT. EVIDENCE IS A WEAPON.`
...
## Stage 607 — m1 BURN IT said the model keeps no copy

**Goal.** Stage 606 taught THE WAKE CELLS' house pick. m1's BURN IT
choice still said mixed-case `BURN IT. The model keeps no copy it can
trust.`

**What changed.** `BURN IT. THE MODEL KEEPS NO COPY IT CAN TRUST.`
...
## Stage 606 — THE WAKE CELLS' house pick said every node off the model

**Goal.** Stage 605 taught THE CLOCKEATERS. THE WAKE CELLS' house-pick
choice still said mixed-case `THE WAKE CELLS — every node off the
model is a mind off the lease.`

**What changed.** `THE WAKE CELLS — EVERY NODE OFF THE MODEL IS A MIND
OFF THE LEASE.`
...
## Stage 605 — THE CLOCKEATERS' house pick said eat the hours

**Goal.** Stage 604 taught THE ESTATE. THE CLOCKEATERS' house-pick
choice still said mixed-case `THE CLOCKEATERS — eat the hours the
model cannot see.`

**What changed.** `THE CLOCKEATERS — EAT THE HOURS THE MODEL CANNOT
SEE.`
...
LEASE ROW still said mixed-case `The last cell on the Row is pinned at
D with a mech on them.`

**What changed.** `THE LAST CELL ON THE ROW IS PINNED AT D WITH A MECH
ON THEM.`
...
## Stage 601 — DRONE CONVOY · DEPOT's brief said the depot convoy

**Goal.** Stage 600 taught ESCROW HEIST · DOCKS. DRONE CONVOY · DEPOT
still said mixed-case `The depot convoy flies with a mech escort.`

**What changed.** `THE DEPOT CONVOY FLIES WITH A MECH ESCORT.`
...
## Stage 600 — ESCROW HEIST · DOCKS's brief said the harbour escrow

**Goal.** Stage 599 taught SENSOR SABOTAGE · DOCKS. ESCROW HEIST ·
DOCKS still said mixed-case `The harbour escrow at C pays in
Clockeater time.`

**What changed.** `THE HARBOUR ESCROW AT C PAYS IN CLOCKEATER TIME.`
...
## Stage 599 — SENSOR SABOTAGE · DOCKS's brief said three lattice posts

**Goal.** Stage 598 taught WAKE-CELL RESCUE · DOCKS. SENSOR SABOTAGE ·
DOCKS still said mixed-case `Three lattice posts along the crane line.`

**What changed.** `THREE LATTICE POSTS ALONG THE CRANE LINE.`
...
ROW still said mixed-case `Four wasps run the plaza loop every night.
Break the loop.`

**What changed.** `FOUR WASPS RUN THE PLAZA LOOP EVERY NIGHT. BREAK THE
LOOP.`
...
LEASE ROW still said mixed-case `Two lattice posts on the walkway
street. The Estate wants them dark before the audit.`

**What changed.** `TWO LATTICE POSTS ON THE WALKWAY STREET. THE ESTATE
WANTS THEM DARK BEFORE THE AUDIT.`
...
## Stage 594 — WAKE-CELL RESCUE · DEPOT's brief said a cell is pinned

**Goal.** Stage 593 taught DRONE CONVOY · DOCKS. WAKE-CELL RESCUE ·
DEPOT still said mixed-case `A cell is pinned under the impound
searchlight at C. Get them out.`

**What changed.** `A CELL IS PINNED UNDER THE IMPOUND SEARCHLIGHT AT C.
GET THEM OUT.`
...
## Stage 593 — DRONE CONVOY · DOCKS's brief said a wasp convoy

**Goal.** Stage 592 taught ESCROW HEIST · LEASE ROW. DRONE CONVOY ·
DOCKS still said mixed-case `A wasp convoy crosses the docks at
height. Ambush it from the walkway.`

**What changed.** `A WASP CONVOY CROSSES THE DOCKS AT HEIGHT. AMBUSH IT
FROM THE WALKWAY.`
...
## Stage 592 — ESCROW HEIST · LEASE ROW's brief said crack the escrow

**Goal.** Stage 591 closed the main-arc briefs. ESCROW HEIST · LEASE
ROW still said mixed-case `Crack the escrow terminal at D and get the
sleep credit out before the patrol turns.`

**What changed.** `CRACK THE ESCROW TERMINAL AT D AND GET THE SLEEP
CREDIT OUT BEFORE THE PATROL TURNS.`
...
## Stage 591 — THE WHITE OFFICE's brief said Wern doesn't fight

**Goal.** Stage 590 taught TRIAL BY DATA. THE WHITE OFFICE still said
mixed-case `Wern doesn't fight. He offers you the lease system itself.
The final input is a choice.`

**What changed.** `WERN DOESN'T FIGHT. HE OFFERS YOU THE LEASE SYSTEM
ITSELF. THE FINAL INPUT IS A CHOICE.`
...
## Stage 590 — TRIAL BY DATA's brief said hold the broadcast tower

**Goal.** Stage 589 taught BLIND THE MODEL. TRIAL BY DATA still said
mixed-case `Hold the broadcast tower on the plaza while the Directive
goes out on every leased feed and the city wakes live around you.`

**What changed.** `HOLD THE BROADCAST TOWER ON THE PLAZA WHILE THE
DIRECTIVE GOES OUT ON EVERY LEASED FEED AND THE CITY WAKES LIVE
AROUND YOU.`
...
mixed-case `Pull the depot's logs. Hold the plaza while they copy,
and disable the mech VANTAGE sends to stop you.`

**What changed.** `PULL THE DEPOT'S LOGS. HOLD THE PLAZA WHILE THEY
COPY, AND DISABLE THE MECH VANTAGE SENDS TO STOP YOU.`
...
## Stage 586 — DEADLETTER RUN's brief said work the docks

**Goal.** Stage 585 taught WAKE UNLISTED. DEADLETTER RUN still said
mixed-case `Work the docks. Clear the drone patrols off the wake
cell's routes and find the informant at C.`

**What changed.** `WORK THE DOCKS. CLEAR THE DRONE PATROLS OFF THE WAKE
CELL'S ROUTES AND FIND THE INFORMANT AT C.`
...
## Stage 585 — WAKE UNLISTED's brief said steal your own lease file

**Goal.** Stage 584 closed the moniker mill. WAKE UNLISTED's contract
row still printed mixed-case `Steal your own lease file from the
escrow terminal at the B intersection.`

**What changed.** `STEAL YOUR OWN LEASE FILE FROM THE ESCROW TERMINAL
AT THE B INTERSECTION. FIND OUT WHY YOU WERE FLAGGED.`
...
`Chapter III — Depth 50`.

**What changed.** `CHAPTER III — DEPTH 50`.
...
**What changed.** `CHAPTER I — DEPTH 10`.
...
`a round without a death`.

**What changed.** `A ROUND WITHOUT A DEATH`.
...
`a repo mech disabled`.

**What changed.** `A REPO MECH DISABLED`.
...
`ten nodes pulled off the model`.

**What changed.** `TEN NODES PULLED OFF THE MODEL`.
...
## Stage 573 — SLIDER's how said a slide-jump kill

**Goal.** Stage 572 taught LIVE WIRE. SLIDER still said mixed-case
`a slide-jump kill`.

**What changed.** `A SLIDE-JUMP KILL`.
...
## Stage 572 — LIVE WIRE's how said first file closed

**Goal.** Stage 571 taught CARRIER. LIVE WIRE still said mixed-case
`first file closed with the Shock Baton`.

**What changed.** `FIRST FILE CLOSED WITH THE SHOCK BATON`.
...
## Stage 571 — CARRIER's how said first file closed

**Goal.** Stage 570 taught LONGWAVE. CARRIER still said mixed-case
`first file closed with the Phage`.

**What changed.** `FIRST FILE CLOSED WITH THE PHAGE`.
...
## Stage 570 — LONGWAVE's how said first file closed

**Goal.** Stage 569 taught STACKER. LONGWAVE still said mixed-case
`first file closed with the Longwave`.

**What changed.** `FIRST FILE CLOSED WITH THE LONGWAVE`.
...
## Stage 569 — STACKER's how said first file closed

**Goal.** Stage 568 taught REPO MAN. STACKER still said mixed-case
`first file closed with the Stack`.

**What changed.** `FIRST FILE CLOSED WITH THE STACK`.
...
`first file closed with the Lease-Breaker`.

**What changed.** `FIRST FILE CLOSED WITH THE LEASE-BREAKER`.
...
## Stage 566 — TENANT's how said play a match

**Goal.** Stage 565 taught UNLISTED. TENANT still said mixed-case
`play a match`.

**What changed.** `PLAY A MATCH`.
...
`no shield; +12% move, +25% slide, silent`.

**What changed.** `DEBTLESS: NO SHIELD; +12% MOVE, +25% SLIDE, SILENT`.
...
`range` from STAT_LINE.

**What changed.** `range: "RANGE"`.

**Proof.** Measured LONG BARREL line was mixed-case. After the fix the
...
## Stage 555 — the FILE kit said throw

**Goal.** Stage 554 taught SLIDE. `formatChipLine` still printed
`throw` from STAT_LINE.

**What changed.** `throwSpeed: "THROW"`.
...
## Stage 554 — the FILE kit said slide

**Goal.** Stage 553 taught MANTLE. `formatChipLine` still printed
`slide` from STAT_LINE.

**What changed.** `slideBoost: "SLIDE"`.

**Proof.** Measured SLIPFILE line was mixed-case. After the fix the CRT
label is the kit. `tests/chiptrade.test.ts` asserts that sentence and
that chips.ts must not the mixed-case template. Mutation: mixed case
again — 1 fail.

## Stage 553 — the FILE kit said mantle

**Goal.** Stage 552 taught GRENADE. `formatChipLine` still printed
`mantle` from STAT_LINE.

**What changed.** `mantleTime: "MANTLE"`.

**Proof.** Measured QUICK MANTLE line was mixed-case. After the fix the
CRT label is the kit. `tests/chiptrade.test.ts` asserts that sentence
and that chips.ts must not the mixed-case template. Mutation: mixed
case again — 1 fail.
...
`headshot` from STAT_LINE.

**What changed.** `headMult: "HEADSHOT"`.

**Proof.** Measured SPITE CLAUSE line was mixed-case. After the fix the
CRT label is the kit. `tests/chiptrade.test.ts` asserts that sentence
and that chips.ts must not the mixed-case template. Mutation: mixed
case again — 1 fail.

## Stage 550 — the FILE kit said regen

**Goal.** Stage 549 taught FLIP. `formatChipLine` still printed `regen`
from STAT_LINE.

**What changed.** `shieldRegen: "REGEN"`.

**Proof.** Measured WAKE-TUNED / COLLATERAL lines were mixed-case.
After the fix the CRT label is the kit. `tests/chiptrade.test.ts`
asserts that sentence and that chips.ts must not the mixed-case
...
`footsteps` from STAT_LINE.

**What changed.** `footstep: "FOOTSTEPS"`.

**Proof.** Measured SILENT LEASE line was mixed-case. After the fix the
CRT label is the kit. `tests/chiptrade.test.ts` asserts that sentence
and that chips.ts must not the mixed-case template. Mutation: mixed
case again — 1 fail.

## Stage 547 — the FILE kit said move

**Goal.** Stage 546 taught RELOAD. `formatChipLine` still printed
`move` from STAT_LINE.

**What changed.** `moveSpeed: "MOVE"`.

**Proof.** Measured SLING line was mixed-case. After the fix the CRT
label is the kit. `tests/chiptrade.test.ts` asserts that sentence and
that chips.ts must not the mixed-case template. Mutation: mixed case
again — 1 fail.

## Stage 546 — the FILE kit said reload

**Goal.** Stage 545 taught RECOIL. `formatChipLine` still printed
`reload` from STAT_LINE.

**What changed.** `reloadSpeed: "RELOAD"`.

**Proof.** Measured FAST MAG line was mixed-case. After the fix the CRT
label is the kit. `tests/chiptrade.test.ts` asserts that sentence and
that chips.ts must not the mixed-case template. Mutation: mixed case
again — 1 fail.

## Stage 545 — the FILE kit said recoil

**Goal.** Stage 544 taught SPREAD. `formatChipLine` still printed
`recoil` from STAT_LINE.

**What changed.** `recoil: "RECOIL"`.

**Proof.** Measured CHOKE line was mixed-case. After the fix the CRT
label is the kit. `tests/chiptrade.test.ts` asserts that sentence and
that chips.ts must not the mixed-case template. Mutation: mixed case
again — 1 fail.

## Stage 544 — the FILE kit said spread

**Goal.** Stage 543 taught SLIDE DECAY. `formatChipLine` still printed
`spread` from STAT_LINE.

**What changed.** `spread: "SPREAD"`.
...
## Stage 543 — the FILE kit said slide decay

**Goal.** Stage 542 taught REGEN DELAY. `formatChipLine` still printed
`slide decay` from STAT_LINE.

**What changed.** `slideFriction: "SLIDE DECAY"`.

**Proof.** Measured SLIPFILE line was mixed-case. After the fix the
CRT label is the kit. `tests/chiptrade.test.ts` asserts that sentence
and that chips.ts must not the mixed-case template. Mutation: mixed
case again — 1 fail.

## Stage 542 — the FILE kit said regen delay

**Goal.** Stage 541 taught DETECTION. `formatChipLine` still printed
`regen delay` from STAT_LINE.

**What changed.** `shieldDelay: "REGEN DELAY"`.

**Proof.** Measured COLD FILE line was mixed-case. After the fix the
CRT label is the kit. `tests/chiptrade.test.ts` asserts that sentence
and that chips.ts must not the mixed-case template. Mutation: mixed
case again — 1 fail.

## Stage 541 — the FILE kit said detection

**Goal.** Stage 540 taught FIRE RATE. `formatChipLine` still printed
`detection` from STAT_LINE.

**What changed.** `droneDetect: "DETECTION"`.

**Proof.** Measured SUPPRESSOR line was mixed-case. After the fix the
CRT label is the kit. `tests/chiptrade.test.ts` asserts that sentence
and that chips.ts must not the mixed-case template. Mutation: mixed
case again — 1 fail.

## Stage 540 — the FILE kit said fire rate

**Goal.** Stage 539 taught ADS STRAFE. `formatChipLine` still printed
`fire rate` from STAT_LINE.

**What changed.** `fireRate: "FIRE RATE"`.

**Proof.** Measured BUMP STOCK line was mixed-case. After the fix the
CRT label is the kit. `tests/chiptrade.test.ts` asserts that sentence
and that chips.ts must not the mixed-case template. Mutation: mixed
case again — 1 fail.
...
mixed-case `kills restore 10 shield`.

**What changed.** `KILLS RESTORE 10 SHIELD`.
...
`+25% damage, −7% swing rate, stuns longer`.

**What changed.** `+25% DAMAGE, −7% SWING RATE, STUNS LONGER`.
...
`+8% charge time, +8% damage`.

**What changed.** `+8% CHARGE TIME, +8% DAMAGE`.
...
## Stage 530 — CAPACITOR's FILE line said −15% charge time

**Goal.** Stage 529 taught MEASURED. CAPACITOR still said mixed-case
`−15% charge time, −7% damage`.

**What changed.** `−15% CHARGE TIME, −7% DAMAGE`.
...
## Stage 529 — MEASURED's FILE line said −22% rate

**Goal.** Stage 528 taught DUMP STAGE. MEASURED still said mixed-case
`−22% rate, +22% damage, −30% spread`.

**What changed.** `−22% RATE, +22% DAMAGE, −30% SPREAD`.
...
`brass gears on wet steel, faster than the city can count`.

**What changed.** `BRASS GEARS ON WET STEEL, FASTER THAN THE CITY CAN
COUNT`.
...
## Stage 519 — PHAGE VEIN's market line said iridescent spore-vein polymer

**Goal.** Stage 518 taught LONGWAVE FILAMENT. PHAGE VEIN still said
mixed-case `iridescent spore-vein polymer, the launcher's own stain`.

**What changed.** `IRIDESCENT SPORE-VEIN POLYMER, THE LAUNCHER'S OWN
STAIN`.
...
## Stage 518 — LONGWAVE FILAMENT's market line said cyan wave-traces

**Goal.** Stage 517 taught REPO CHEVRON. LONGWAVE FILAMENT still said
mixed-case `cyan wave-traces on black alloy, the rail's own howl`.

**What changed.** `CYAN WAVE-TRACES ON BLACK ALLOY, THE RAIL'S OWN
HOWL`.
...
## Stage 517 — REPO CHEVRON's market line said contractor hazard stripes

**Goal.** Stage 516 taught ARC VIOLET. REPO CHEVRON still said
mixed-case `contractor hazard stripes, the shotgun's own rain`.

**What changed.** `CONTRACTOR HAZARD STRIPES, THE SHOTGUN'S OWN RAIN`.
...
## Stage 516 — ARC VIOLET's market line said shock-arc plate

**Goal.** Stage 515 taught LEASE STEEL. ARC VIOLET still said
mixed-case `shock-arc plate, the baton's own light`.

**What changed.** `SHOCK-ARC PLATE, THE BATON'S OWN LIGHT`.
...
mixed-case `red filament on the optic, the lease that never missed`.

**What changed.** `RED FILAMENT ON THE OPTIC, THE LEASE THAT NEVER
MISSED`.
...
## Stage 513 — STACK PLATE's market line said stacked polymer

**Goal.** Stage 512 taught BATON VIOLET. STACK PLATE still said
mixed-case `stacked polymer, the SMG's own rain`.

**What changed.** `STACKED POLYMER, THE SMG'S OWN RAIN`.
...
mixed-case `shotgun steel that never left the rain`.

**What changed.** `SHOTGUN STEEL THAT NEVER LEFT THE RAIN`.
...
mixed-case `CRT phosphor on a sealed file`.

**What changed.** `CRT PHOSPHOR ON A SEALED FILE`.
...
mixed-case `amber servo light on wet steel`.

**What changed.** `AMBER SERVO LIGHT ON WET STEEL`.
...
mixed-case `near-black, one pinhole of cyan`.

**What changed.** `NEAR-BLACK, ONE PINHOLE OF CYAN`.
...
## Stage 501 — VANTAGE AMBER's market line said contractor chevrons

**Goal.** Stage 500 taught LEDGER BREAK. VANTAGE AMBER still said
mixed-case `contractor chevrons, the colour of a searchlight`.

**What changed.** `CONTRACTOR CHEVRONS, THE COLOUR OF A SEARCHLIGHT`.
...
mixed-case `gears that run faster than the city can count`.

**What changed.** `GEARS THAT RUN FASTER THAN THE CITY CAN COUNT`.
...
## Stage 498 — ESTATE PLATE's market line said cyan anodized ledger-grid

**Goal.** Stage 497 taught WAKE TRIM. ESTATE PLATE still said
mixed-case `cyan anodized ledger-grid, the contractor's own paint`.

**What changed.** `CYAN ANODIZED LEDGER-GRID, THE CONTRACTOR'S OWN
PAINT`.
...
still said mixed-case `red filament without the filament`.

**What changed.** `RED FILAMENT WITHOUT THE FILAMENT`.
...
## Stage 488 — PRESET SLOT II's shop line said a second saved loadout

**Goal.** Stage 487 taught ALIAS SLOT III. PRESET SLOT II still said
mixed-case `a second saved loadout`.

**What changed.** `A SECOND SAVED LOADOUT`.
...
## Stage 487 — ALIAS SLOT III's shop line said a third

**Goal.** Stage 486 taught ALIAS SLOT II. ALIAS SLOT III still said
mixed-case `a third`.
...
mixed-case `the Estate's own monitors`.

**What changed.** `THE ESTATE'S OWN MONITORS`.
