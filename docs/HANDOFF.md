...
Written 2026-09-22, at Stage 446, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 446 on this branch (chip IS A CHIP) |
| Next stage number | **447** |
...
Stage 446 CRT-cased chip `IS A … CHIP`. Chip-socket still kicks
`is a MUZZLE chip, not KINETIC`. Do not loosen fairness. Do not plate
