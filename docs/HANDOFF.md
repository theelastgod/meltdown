...
Written 2026-09-21, at Stage 244, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 244 on this branch (closed-contract ledger names RED LEASE) |
| Next stage number | **245** |
...
Stage 244 made the closed-contract ledger name RED LEASE. Do not loosen fairness.
