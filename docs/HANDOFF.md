...
Written 2026-09-22, at Stage 416, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 416 on this branch (UNKNOWN HOUSE) |
| Next stage number | **417** |
...
Stage 416 CRT-cased `UNKNOWN HOUSE`. Campaign still returns
`house already picked`. Do not loosen fairness. Do not plate viewmodel or
