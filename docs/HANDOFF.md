...
Written 2026-09-22, at Stage 428, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 428 on this branch (UNKNOWN ITEM) |
| Next stage number | **429** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1196 across 117 files, `npm test` |
...
Stage 428 CRT-cased `UNKNOWN ITEM`. Buying a node the file already holds
still returns `already in your file`. Do not loosen fairness. Do not plate
