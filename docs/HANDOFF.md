...
Written 2026-09-21, at Stage 246, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 246 on this branch (not-a-node kick says KEYSTONE) |
| Next stage number | **247** |
