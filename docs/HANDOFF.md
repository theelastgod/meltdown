...
Written 2026-09-21, at Stage 298, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 298 on this branch (drop line CRT-cases the kick) |
| Next stage number | **299** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1072 across 117 files, `npm test` |
...
Stage 298 CRT-cases kick reasons on the drop line. Do not loosen fairness. Do not plate
