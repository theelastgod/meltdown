...
Written 2026-09-21, at Stage 305, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 305 on this branch (LISTED · TOKEN) |
| Next stage number | **306** |
...
Stage 305 CRT-cased `LISTED · TOKEN`. Wallet-refused lines still mix sentence case.
Do not loosen fairness. Do not plate viewmodel or remote strips. The join line still
