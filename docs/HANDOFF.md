...
Written 2026-09-21, at Stage 258, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 258 on this branch (monorail tail lamp wears tex_lamp) |
| Next stage number | **259** |
...
Stage 258 put `tex_lamp` on the monorail tail. The airship nose is still unplated red. Do not
loosen fairness.
