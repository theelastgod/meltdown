...
Written 2026-09-22, at Stage 485, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 485 on this branch (BLOODLINE shop line) |
| Next stage number | **486** |
...
Stage 485 CRT-cased BLOODLINE's shop line. ALIAS SLOT II still says
`a second saved name the city may call you`. Title cards stay prose
