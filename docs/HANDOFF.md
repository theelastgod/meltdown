...
Written 2026-09-21, at Stage 313, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 313 on this branch (SELL FAILED is CRT) |
| Next stage number | **314** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1083 across 117 files, `npm test` |
...
Stage 313 CRT-cased `SELL FAILED`. `ROOM FAILED:` / `NAME FAILED:` still interpolate
the caught error. Do not loosen fairness. Do not plate viewmodel or remote strips.
