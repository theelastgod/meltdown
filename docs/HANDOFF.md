...
Written 2026-09-23, at Stage 618, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 618 on this branch (m5 SPARE THE DOCKS) |
| Next stage number | **619** |
...
Stage 618 CRT-cased m5 SPARE THE DOCKS. m6 FULL BROADCAST still says
mixed-case `Let them read the fire too`. Title cards stay prose
