...
Written 2026-09-22, at Stage 397, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 397 on this branch (moniker NONE) |
| Next stage number | **398** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1166 across 117 files, `npm test` |
...
Stage 397 CRT-cased moniker empty `— NONE —`. FILE still dims mastery
`${into}/${need} xp`. Do not loosen fairness. Do not plate viewmodel or
