...
Written 2026-09-22, at Stage 576, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 576 on this branch (DRONE BANE how) |
| Next stage number | **577** |
...
Stage 576 CRT-cased DRONE BANE's how. MECH BREAKER still says mixed-case
`a repo mech disabled`. Title cards stay prose (probe:ship asserts them).
