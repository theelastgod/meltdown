...
Written 2026-09-22, at Stage 370, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 370 on this branch (unlinked RUN dim is CRT) |
| Next stage number | **371** |
...
Stage 370 CRT-cased THE RUN's unlinked dim. Do not loosen fairness. Do not plate
