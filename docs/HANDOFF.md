...
Written 2026-09-22, at Stage 384, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 384 on this branch (Ledger Graph sandbox footer is CRT) |
| Next stage number | **385** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1153 across 117 files, `npm test` |
...
Stage 384 CRT-cased the Ledger Graph sandbox footer. Do not loosen fairness. Do
not plate viewmodel or remote strips. The join line still prints the socket
