...
Written 2026-09-21, at Stage 295, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 295 on this branch (metro lock glyph wears tex_lamp) |
| Next stage number | **296** |
...
Stage 295 put `tex_lamp` on the metro lock glyph. City neon tubes are still unplated. Do
not loosen fairness. Do not plate viewmodel or remote strips (skin maps overwrite those).
