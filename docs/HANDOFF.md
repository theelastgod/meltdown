...
Written 2026-09-22, at Stage 572, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 572 on this branch (LIVE WIRE how) |
| Next stage number | **573** |
...
Stage 572 CRT-cased LIVE WIRE's how. SLIDER still says mixed-case
`a slide-jump kill`. Title cards stay prose (probe:ship asserts them).
