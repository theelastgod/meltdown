...
Written 2026-09-22, at Stage 355, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 355 on this branch (NOTHING ON THE RIG YET) |
| Next stage number | **356** |
...
Stage 355 CRT-cased `NOTHING ON THE RIG YET`. FILE identity still writes
`files on you`. Do not loosen fairness. Do not plate viewmodel or remote strips.
