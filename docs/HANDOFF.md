...
Written 2026-09-22, at Stage 422, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 422 on this branch (Imagine FX/kit plates) |
| Next stage number | **423** |
...
Stage 422 bound Imagine plates onto tracer, blast, spark, optic and WAKE hex.
Launching out of order still returns `${next.title} comes first`. Do not loosen
