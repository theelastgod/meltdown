...
Written 2026-09-23, at Stage 623, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 623 on this branch (m7 TAKE THE CHAIR Estate) |
| Next stage number | **624** |
...
Stage 623 CRT-cased m7 TAKE THE CHAIR (Estate). All campaign *choice*
lines are CRT. Handler dialogue still prints mixed-case (`Ida Vessel. I
audited leases for eleven years…`). Title cards stay prose (probe:ship
