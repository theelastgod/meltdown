...
Written 2026-09-22, at Stage 508, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 508 on this branch (BLACK LEASE market line) |
| Next stage number | **509** |
...
Stage 508 CRT-cased BLACK LEASE's market line. PHAGE PLATE still says
mixed-case `green-black contagion paint`. Title cards
