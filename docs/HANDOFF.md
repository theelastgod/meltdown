...
Written 2026-09-22, at Stage 473, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 473 on this branch (WAKE menu line) |
| Next stage number | **474** |
...
Stage 473 CRT-cased WAKE's menu subtitle. THE RUN's subtitle still
says `play to earn`. Do not loosen fairness. Do not plate viewmodel
