...
Written 2026-09-21, at Stage 304, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 304 on this branch (BOUGHT · LISTING) |
| Next stage number | **305** |
...
Stage 304 CRT-cased `BOUGHT · LISTING`. `LISTED · token` is still sentence case. Do
not loosen fairness. Do not plate viewmodel or remote strips. The join line still
