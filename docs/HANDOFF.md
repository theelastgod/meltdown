...
Written 2026-09-22, at Stage 575, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 575 on this branch (FULL WAKE how) |
| Next stage number | **576** |
...
Stage 575 CRT-cased FULL WAKE's how. DRONE BANE still says mixed-case
`ten wasps downed`. Title cards stay prose (probe:ship asserts them).
