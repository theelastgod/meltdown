...
Written 2026-09-22, at Stage 537, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 537 on this branch (ESCROW LOCK FILE lead) |
| Next stage number | **538** |
...
Stage 537 CRT-cased ESCROW LOCK's FILE lead. VANTAGE BANE still
says mixed-case `bonus damage to VANTAGE units`. Title cards stay prose
