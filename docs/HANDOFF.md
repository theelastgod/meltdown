...
Written 2026-09-22, at Stage 327, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 327 on this branch (RANGE alert times are S) |
| Next stage number | **328** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1099 across 117 files, `npm test` |
...
Stage 327 CRT-cased the RANGE alert. `LINK LOST · REJOINING IN` still suffixes
`1.0s`. Do not loosen fairness. Do not plate viewmodel or remote strips. The
