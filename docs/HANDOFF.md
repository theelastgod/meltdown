...
Written 2026-09-22, at Stage 345, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 345 on this branch (1 CLAIM OUT not CLAIMS OUT) |
| Next stage number | **346** |
...
Stage 345 CRT-cased `1 CLAIM OUT`. Dropping `1 UNITS` is still always plural. Do not
