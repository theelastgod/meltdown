...
Written 2026-09-22, at Stage 566, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 566 on this branch (TENANT how) |
| Next stage number | **567** |
...
Stage 566 CRT-cased TENANT's how. LEASE-BREAKER still says mixed-case
`first file closed with the Lease-Breaker`. Title cards stay prose
