...
Written 2026-09-21, at Stage 251, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 251 on this branch (mech visor strip wears tex_lamp) |
| Next stage number | **252** |
...
Stage 251 put `tex_lamp` on the mech visor strip. Wasp eyes are still a flat amber box. Do not
loosen fairness.
