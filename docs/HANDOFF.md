...
Written 2026-09-21, at Stage 308, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 308 on this branch (NO WALLET rest is CRT) |
| Next stage number | **309** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1080 across 117 files, `npm test` |
...
Stage 308 CRT-cased the `NO WALLET:` rest. `LINK REFUSED:` still interpolates
the host reason as written. Do not loosen fairness. Do not plate viewmodel or
