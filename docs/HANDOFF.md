...
Written 2026-09-22, at Stage 375, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 375 on this branch (UNITS SETTLE NIGHTLY is CRT) |
| Next stage number | **376** |
...
Stage 375 CRT-cased `UNITS SETTLE NIGHTLY`. `VANTAGE priced you. This is the other
book.` is still sentence case. Do not loosen fairness. Do not plate viewmodel or
