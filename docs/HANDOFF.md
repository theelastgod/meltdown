...
Written 2026-09-22, at Stage 394, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 394 on this branch (NEEDS DEPTH) |
| Next stage number | **395** |
...
Stage 394 CRT-cased `NEEDS DEPTH`. FILE still dims `not in your file`. Do not
