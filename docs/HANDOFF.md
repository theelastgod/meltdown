...
Written 2026-09-23, at Stage 617, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 617 on this branch (m5 ALL OF IT) |
| Next stage number | **618** |
...
Stage 617 CRT-cased m5 ALL OF IT. m5 SPARE THE DOCKS still says
mixed-case `Someone has to see the ships come in`. Title cards stay
