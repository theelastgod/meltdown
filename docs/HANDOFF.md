...
Written 2026-09-21, at Stage 276, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 276 on this branch (campaign objective ring wears tex_lamp) |
| Next stage number | **277** |
...
Stage 276 put `tex_lamp` on the campaign objective ring. Do not loosen fairness.
