...
Written 2026-09-22, at Stage 426, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 426 on this branch (ALREADY CLAIMED) |
| Next stage number | **427** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1194 across 117 files, `npm test` |
...
Stage 426 CRT-cased `ALREADY CLAIMED`. An id off today's board still
returns `not on today's board`. Do not loosen fairness. Do not plate
