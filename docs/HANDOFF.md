...
Written 2026-09-22, at Stage 549, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 549 on this branch (FLIP STAT_LINE) |
| Next stage number | **550** |
