...
Written 2026-09-23, at Stage 608, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 608 on this branch (m1 KEEP IT) |
| Next stage number | **609** |
...
Stage 608 CRT-cased m1 KEEP IT. m2 SPARE HIM still says mixed-case
`Turn the speaker off and let him run`. Title cards stay prose
