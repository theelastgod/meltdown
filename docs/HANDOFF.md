...
Written 2026-09-22, at Stage 429, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 429 on this branch (ALREADY IN YOUR FILE) |
| Next stage number | **430** |
...
Stage 429 CRT-cased `ALREADY IN YOUR FILE`. A Depth-gated buy still
returns `needs Depth N`. Do not loosen fairness. Do not plate
