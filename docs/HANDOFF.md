...
Written 2026-09-22, at Stage 366, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 366 on this branch (closed name registry is CRT) |
| Next stage number | **367** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1136 across 117 files, `npm test` |
...
Stage 366 CRT-cased the closed name registry. Do not loosen fairness. Do not plate
