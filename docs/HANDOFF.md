...
Written 2026-09-21, at Stage 273, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 273 on this branch (WAKE ring wears tex_lamp) |
| Next stage number | **274** |
...
Stage 273 put `tex_lamp` on THE WAKE's hex ring. Do not loosen fairness.
