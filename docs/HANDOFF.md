...
Written 2026-09-22, at Stage 427, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 427 on this branch (NOT ON TODAY'S BOARD) |
| Next stage number | **428** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1195 across 117 files, `npm test` |
...
Stage 427 CRT-cased `NOT ON TODAY'S BOARD`. Buying an id the ledger
catalogue does not have still returns `unknown item`. Do not loosen
