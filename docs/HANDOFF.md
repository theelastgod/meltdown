...
Written 2026-09-22, at Stage 328, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 328 on this branch (REJOINING wait is S) |
| Next stage number | **329** |
...
Stage 328 CRT-cased the rejoin wait. Kill TTK still suffixes `${n}s`. Do not
