...
Written 2026-09-22, at Stage 430, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 430 on this branch (buyNode NEEDS DEPTH) |
| Next stage number | **431** |
...
Stage 430 CRT-cased buyNode `NEEDS DEPTH`. A poor buy still returns
`needs N Scrip`. Do not loosen fairness. Do not plate viewmodel or remote
