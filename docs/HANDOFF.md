...
Written 2026-09-22, at Stage 565, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 565 on this branch (UNLISTED how) |
| Next stage number | **566** |
...
Stage 565 CRT-cased UNLISTED's how. TENANT still says mixed-case
`play a match`. Title cards stay prose (probe:ship asserts them).
