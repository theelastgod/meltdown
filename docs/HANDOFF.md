...
Written 2026-09-22, at Stage 419, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 419 on this branch (UNKNOWN CONTRACT) |
| Next stage number | **420** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1188 across 117 files, `npm test` |
...
Stage 419 CRT-cased `UNKNOWN CONTRACT`. Launching a mission with no house
still returns `pick a house first`. Do not loosen fairness. Do not plate
