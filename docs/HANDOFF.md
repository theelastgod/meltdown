...
Written 2026-09-22, at Stage 448, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 448 on this branch (firmware IS A FIRMWARE) |
| Next stage number | **449** |
...
Stage 448 CRT-cased firmware `IS A … FIRMWARE`. Attesting a keystone as a
node still kicks `is a KEYSTONE`. Do not loosen fairness. Do not plate
