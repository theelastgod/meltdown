...
Written 2026-09-22, at Stage 477, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 477 on this branch (THE RANGE menu line) |
| Next stage number | **478** |
...
Stage 477 CRT-cased THE RANGE's menu subtitle. FILE's subtitle still
says `the Ghostfile`. Do not loosen fairness. Do not plate viewmodel
