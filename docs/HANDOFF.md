...
Written 2026-09-22, at Stage 548, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 548 on this branch (FOOTSTEPS STAT_LINE) |
| Next stage number | **549** |
...
Stage 548 CRT-cased STAT_LINE `FOOTSTEPS`. STAT_LINE `flip` still
