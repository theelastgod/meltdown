...
Written 2026-09-22, at Stage 543, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 543 on this branch (SLIDE DECAY STAT_LINE) |
| Next stage number | **544** |
...
Stage 543 CRT-cased STAT_LINE `SLIDE DECAY`. Remaining STAT_LINE
labels still print mixed-case (`spread`, `recoil`, `reload`, `move`,
