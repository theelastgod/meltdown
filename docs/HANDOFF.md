...
Written 2026-09-22, at Stage 344, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 344 on this branch (1 MECH not MECHS) |
| Next stage number | **345** |
...
Stage 344 CRT-cased `1 MECH`. Do not loosen fairness. Do not plate viewmodel or
