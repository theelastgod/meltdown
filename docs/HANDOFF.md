...
Written 2026-09-22, at Stage 365, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 365 on this branch (written-name how-to is CRT) |
| Next stage number | **366** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1135 across 117 files, `npm test` |
...
Stage 365 CRT-cased the written-name how-to. Do not loosen fairness. Do not plate
