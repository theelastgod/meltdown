...
Written 2026-09-22, at Stage 330, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 330 on this branch (RANGE ledger times are S) |
| Next stage number | **331** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1102 across 117 files, `npm test` |
...
Stage 330 CRT-cased the RANGE ledger. FLIP / LOCK IN on the node readout still
suffixes `s`. Do not loosen fairness. Do not plate viewmodel or remote strips.
