...
Written 2026-09-22, at Stage 474, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 474 on this branch (THE RUN menu line) |
| Next stage number | **475** |
...
Stage 474 CRT-cased THE RUN's menu subtitle. CAMPAIGN's subtitle still
says `the desk at the Deadletter Office`. Do not loosen fairness. Do
