...
Written 2026-09-22, at Stage 362, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 362 on this branch (treasury LOADING) |
| Next stage number | **363** |
...
Stage 362 CRT-cased treasury `LOADING…`. The counter still dims `fetching the
chain client…`. Do not loosen fairness. Do not plate viewmodel or remote strips.
