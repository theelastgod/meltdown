...
Written 2026-09-22, at Stage 476, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 476 on this branch (THE OFFICE menu line) |
| Next stage number | **477** |
...
Stage 476 CRT-cased THE OFFICE's menu subtitle. THE RANGE's subtitle
still says `the drainage yard`. Do not loosen fairness. Do not plate
