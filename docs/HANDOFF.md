...
Written 2026-09-21, at Stage 294, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 294 on this branch (traffic streaks wear tex_lamp) |
| Next stage number | **295** |
...
Stage 294 put `tex_lamp` on horizon traffic. Do not loosen fairness. Do not plate viewmodel
