...
Written 2026-09-21, at Stage 261, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 261 on this branch (parked-car headlamps wear tex_lamp) |
| Next stage number | **262** |
...
Stage 261 put `tex_lamp` on parked-car headlamps. Spawn pads (`M.padStart` / `M.padEnd`) are still
flat green / magenta, and leftover `tex_wet_asphalt` is still unbound. Do not loosen fairness.
