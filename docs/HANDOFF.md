...
Written 2026-09-22, at Stage 550, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 550 on this branch (REGEN STAT_LINE) |
| Next stage number | **551** |
...
Stage 550 CRT-cased STAT_LINE `REGEN`. STAT_LINE `headshot` still
