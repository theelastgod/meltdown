...
Written 2026-09-23, at Stage 591, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 591 on this branch (THE WHITE OFFICE brief) |
| Next stage number | **592** |
...
Stage 591 CRT-cased THE WHITE OFFICE's brief. ESCROW HEIST · LEASE
ROW still says mixed-case `Crack the escrow terminal at D`. Title
