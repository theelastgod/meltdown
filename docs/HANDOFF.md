...
Written 2026-09-22, at Stage 378, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 378 on this branch (Ledger Market heading is CRT) |
| Next stage number | **379** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1147 across 117 files, `npm test` |
...
Stage 378 CRT-cased the Ledger Market heading. Do not loosen fairness. Do not
