...
Written 2026-09-22, at Stage 379, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 379 on this branch (prizes how-to is CRT) |
| Next stage number | **380** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1148 across 117 files, `npm test` |
...
Stage 379 CRT-cased the prizes how-to. Do not loosen fairness. Do not plate
