...
Written 2026-09-22, at Stage 558, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 558 on this branch (DEBTLESS FILE line) |
| Next stage number | **559** |
...
Stage 558 CRT-cased DEBTLESS's FILE line. BAD DEBT still says mixed-case
`loud on the model`. Title cards stay prose (probe:ship asserts them).
