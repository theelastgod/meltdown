...
Written 2026-09-21, at Stage 248, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 248 on this branch (keystone-limit kick says KEYSTONE) |
| Next stage number | **249** |
...
Stage 248 made the keystone-limit kick say KEYSTONE. Do not loosen fairness.
