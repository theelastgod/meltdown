...
Written 2026-09-21, at Stage 309, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 309 on this branch (LINK REFUSED is CRT) |
| Next stage number | **310** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1081 across 117 files, `npm test` |
...
Stage 309 CRT-cased `LINK REFUSED`. `ROOM REFUSED:` still interpolates the
host reason as written. Do not loosen fairness. Do not plate viewmodel or
