...
Written 2026-09-22, at Stage 404, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 404 on this branch (LIST FOR HOW MUCH) |
| Next stage number | **405** |
...
Stage 404 CRT-cased the rig-list prompt. Rewrite shop refusals still
dim `already owned` / `needs N Wakelight`. Do not loosen fairness. Do not
plate viewmodel or remote strips. The join line still prints the socket
