...
Written 2026-09-23, at Stage 606, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 606 on this branch (THE WAKE CELLS house pick) |
| Next stage number | **607** |
...
Stage 606 CRT-cased THE WAKE CELLS' house pick. m1's BURN IT choice
still says mixed-case `The model keeps no copy it can trust`. Title
