...
Written 2026-09-23, at Stage 607, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 607 on this branch (m1 BURN IT) |
| Next stage number | **608** |
...
Stage 607 CRT-cased m1 BURN IT. m1 KEEP IT still says mixed-case
`Evidence is a weapon`. Title cards stay prose (probe:ship asserts
