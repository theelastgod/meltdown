...
Written 2026-09-23, at Stage 587, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 587 on this branch (VARIANCE brief) |
| Next stage number | **588** |
...
Stage 587 CRT-cased VARIANCE's brief. THE LEAK still says mixed-case
`An Estate defector hands you the Directive`. Title cards stay prose
