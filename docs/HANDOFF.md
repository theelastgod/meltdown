...
Written 2026-09-22, at Stage 407, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 407 on this branch (UNKNOWN COSMETIC) |
| Next stage number | **408** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1176 across 117 files, `npm test` |
...
Stage 407 CRT-cased `UNKNOWN COSMETIC`. Shop still returns
`alias slot N already owned`. Do not loosen fairness. Do not plate viewmodel
