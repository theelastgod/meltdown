...
Written 2026-09-21, at Stage 271, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 271 on this branch (DIRECTIVE optic wears tex_lamp) |
| Next stage number | **272** |
...
Stage 271 put `tex_lamp` on THE DIRECTIVE's optic cube. THE RUN's safe-zone column is still
unplated. Do not loosen fairness.
