...
Written 2026-09-22, at Stage 542, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 542 on this branch (REGEN DELAY STAT_LINE) |
| Next stage number | **543** |
...
Stage 542 CRT-cased STAT_LINE `REGEN DELAY`. STAT_LINE `slide decay`
still prints mixed-case. Title cards stay prose (probe:ship asserts
