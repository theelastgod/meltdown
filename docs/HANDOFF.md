...
Written 2026-09-22, at Stage 433, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 433 on this branch (NOT ON YOUR RIG) |
| Next stage number | **434** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1201 across 117 files, `npm test` |
...
Stage 433 CRT-cased `NOT ON YOUR RIG`. Wearing a token the catalogue does
not have still returns `unknown skin`. Do not loosen fairness. Do not plate
