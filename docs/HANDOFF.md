...
Written 2026-09-22, at Stage 460, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 460 on this branch (MUST TOUCH AN ATTESTED NODE) |
| Next stage number | **461** |
...
Stage 460 CRT-cased `MUST TOUCH AN ATTESTED NODE`. An unknown primary
still kicks `unknown primary ${id}`. Do not loosen fairness. Do not plate
