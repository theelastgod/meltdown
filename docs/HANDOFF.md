...
Written 2026-09-22, at Stage 552, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 552 on this branch (GRENADE STAT_LINE) |
| Next stage number | **553** |
...
Stage 552 CRT-cased STAT_LINE `GRENADE`. Remaining STAT_LINE labels
still print mixed-case (`mantle`, `slide`, `throw`, `range`). Title
