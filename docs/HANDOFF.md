...
Written 2026-09-22, at Stage 577, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 577 on this branch (MECH BREAKER how) |
| Next stage number | **578** |
...
Stage 577 CRT-cased MECH BREAKER's how. DEBT COLLECTOR still says mixed-case
`a Debt cleared`. Title cards stay prose (probe:ship asserts them).
