...
Written 2026-09-23, at Stage 625, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 625 on this branch (Ida second line) |
| Next stage number | **626** |
...
Stage 625 CRT-cased Ida's second creation line. Marrow's first still
says mixed-case `Marrow. Don't say your name`. Title cards stay prose
