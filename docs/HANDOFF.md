...
Written 2026-09-21, at Stage 252, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 252 on this branch (wasp eye wears tex_lamp) |
| Next stage number | **253** |
...
Stage 252 put `tex_lamp` on the wasp eye. Do not loosen fairness.
