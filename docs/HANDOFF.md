...
Written 2026-09-21, at Stage 279, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 279 on this branch (player cloak wears tex_cloak) |
| Next stage number | **280** |
...
Stage 279 put `tex_cloak` on the player's cloak. Do not loosen fairness.
