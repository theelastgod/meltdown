...
Written 2026-09-21, at Stage 317, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 317 on this branch (sink FAILED is CRT) |
| Next stage number | **318** |
...
Stage 317 CRT-cased a thrown sink burn's `FAILED`. `COUNTER-LEDGER:` still
interpolates `String(e)` as written. Do not loosen fairness. Do not plate
