...
Written 2026-09-21, at Stage 272, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 272 on this branch (RUN column wears tex_lamp) |
| Next stage number | **273** |
...
Stage 272 put `tex_lamp` on THE RUN's safe-zone column. Do not loosen fairness.
