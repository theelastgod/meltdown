...
Written 2026-09-22, at Stage 529, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 529 on this branch (MEASURED FILE line) |
| Next stage number | **530** |
...
Stage 529 CRT-cased MEASURED's FILE line. CAPACITOR still says
mixed-case `−15% charge time, −7% damage`. Title cards stay prose
