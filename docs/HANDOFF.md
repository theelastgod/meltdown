...
Written 2026-09-21, at Stage 306, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 306 on this branch (WALLET REFUSED is CRT-cased) |
| Next stage number | **307** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1076 across 117 files, `npm test` |
...
Stage 306 CRT-cased `WALLET REFUSED`. `(local account)` on the wallet line is still
sentence case. Do not loosen fairness. Do not plate viewmodel or remote strips. The
