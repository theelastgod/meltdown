...
Written 2026-09-22, at Stage 526, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 526 on this branch (DOUBLE BARREL FILE line) |
| Next stage number | **527** |
...
Stage 526 CRT-cased DOUBLE BARREL's FILE line. SLAM FIRE still says
mixed-case `+20% rate, −10% pellet damage`. Title cards stay prose
