...
Written 2026-09-22, at Stage 475, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 475 on this branch (CAMPAIGN menu line) |
| Next stage number | **476** |
...
Stage 475 CRT-cased CAMPAIGN's menu subtitle. THE OFFICE's subtitle
still says `the hub`. Do not loosen fairness. Do not plate viewmodel
