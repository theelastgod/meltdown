...
Written 2026-09-21, at Stage 240, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 240 on this branch (unknown-socket kick names LEASE-BREAKER) |
| Next stage number | **241** |
...
Stage 240 made an unknown-socket kick name LEASE-BREAKER. Do not loosen fairness.
