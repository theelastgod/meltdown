...
Written 2026-09-21, at Stage 307, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 307 on this branch (LOCAL ACCOUNT) |
| Next stage number | **308** |
...
Stage 307 CRT-cased `(LOCAL ACCOUNT)`. `NO WALLET:` still has a sentence-case rest.
