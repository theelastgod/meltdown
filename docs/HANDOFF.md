...
Written 2026-09-22, at Stage 503, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 503 on this branch (RAIN LEASE market line) |
| Next stage number | **504** |
...
Stage 503 CRT-cased RAIN LEASE's market line. METRO PLATE still says
mixed-case `grey-green tunnel tile, cyan bars`. Title cards stay
