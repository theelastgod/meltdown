...
Written 2026-09-22, at Stage 559, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 559 on this branch (BAD DEBT FILE line) |
| Next stage number | **560** |
...
Stage 559 CRT-cased BAD DEBT's FILE line. All three keystone FILE
lines are CRT. Campaign protocol lines still print mixed-case (`+12%
fire rate` on WERN PULSE). Title cards stay prose (probe:ship asserts
