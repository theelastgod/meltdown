...
Written 2026-09-22, at Stage 494, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 494 on this branch (FILE crtPhrase off the chain chunk) |
| Next stage number | **495** |
...
Stage 494 moved `crtPhrase` off the chain chunk. KERNEL PLATE still
