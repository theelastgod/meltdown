...
Written 2026-09-22, at Stage 420, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 420 on this branch (PICK A HOUSE FIRST) |
| Next stage number | **421** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1189 across 117 files, `npm test` |
...
Stage 420 CRT-cased `PICK A HOUSE FIRST`. Launching after the arc still
returns `the arc is complete`. Do not loosen fairness. Do not plate viewmodel
