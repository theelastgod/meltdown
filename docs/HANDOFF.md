...
Written 2026-09-22, at Stage 403, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 403 on this branch (firmware R) |
| Next stage number | **404** |
| CI | `verify` runs #202–#208 (Stages 172–178) all green; 179 not yet watched on CI |
| Unit tests | 1172 across 117 files, `npm test` |
...
Stage 403 CRT-cased firmware `· R`. FILE still prompts
`List for how much $CAPITAL?` when listing a rig token. Do not loosen
