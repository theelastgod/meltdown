...
Written 2026-09-22, at Stage 498, for whoever works this next. It is deliberately not addressed to
...
| HEAD | Stage 498 on this branch (ESTATE PLATE market line) |
| Next stage number | **499** |
...
Stage 498 CRT-cased ESTATE PLATE's market line. CLOCKEATER BRASS still
says mixed-case `gears that run faster than the city can count`. Title cards stay
